...
export default function Sidenavbar({ onClose }) {
    const navLinkClass = ({ isActive }) => (isActive ? "text-orange-700 font-bold" : "text-black");
    ...
    return (
        <div className="fixed inset-0 bg-black/40 z-40" onClick={onClose}>
            <div
                className="fixed top-0 left-0 h-screen w-64 bg-white shadow-lg z-50 mx-1 pl-2 py-5 rounded-tr-3xl rounded-br-3xl shadow-gray-900"
            ...
            >
                <div className='flex justify-between items-center pr-2'>
                    <img
                        src={logoimg}
                        alt="Logo"
                        className='h-17 w-17 object-cover rounded-4xl'
                    />
                    <img
                        src={closeMenu}
                        alt="Close menu"
