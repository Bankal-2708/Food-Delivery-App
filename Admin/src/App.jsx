...
const CATEGORIES = ["Pizza", "Dosa", "Momos", "Paneer Roll", "Biryani", "Burger", "Paratha", "Pasta", "Rabri"];
          ...
          <div style={{ background: "#1a1a1a", borderBottom: "1px solid #2a2a2a", padding: "1rem 2rem", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {["dishes", "add", "orders"].map((t) => (
                <button key={t}
                  onClick={() => { setTab(t); if (t !== "add") { setEditId(null); setForm(initialForm); setImagePreview(null); } }}
                  style={{
          ...
          <div style={{ maxWidth: 1000, margin: "0 auto", padding: "2rem 1.5rem" }}>
            ...
            {tab === "orders" && (
              <div>
                ...
                {orders.length === 0 ? (
                  <div style={{ textAalign: "center", padding: "4rem", color: "#555" }}>No orders yet.</div>
                ) : (
...
}// Project ready for senior review
